...
/**
 * WebRTC helper utilities for creating peer connections and media streams.
 * Centralizes WebRTC configuration for voice/video calls.
 * @example
...
class WebRTCService {
  ...
  async createPeerConnection(): Promise<RTCPeerConnection> {
    ...
    // Cast to any for event handler assignment — react-native-webrtc types are
    // incomplete and don't expose the standard W3C event handler properties.
  ...
  // Callback for sending ICE candidates through signaling
